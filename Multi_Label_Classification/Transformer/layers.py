...
class MultiHeadAttention(tf.keras.layers.Layer):
    def __init__(self, d_model, num_heads):
        ...
        self.num_heads = num_heads #注意力个数
        ...
        self.wq = tf.keras.layers.Dense(d_model) #获得q向量的参数
        self.wk = tf.keras.layers.Dense(d_model) #获得k向量的参数
        self.wv = tf.keras.layers.Dense(d_model) #获得v向量的参数
